...
<?php
  ...
  $query = "SELECT COUNT(*) AS count_boookings FROM bookings";
  $count_boookings = $app->selectOne($query);
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">number of bookings: <?php echo $count_boookings->count_boookings;?></p>
