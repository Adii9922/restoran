                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo APPURL; ?>/users/booking.php?id=<?php echo $_SESSION['user_id']; ?>">Booking</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <?php foreach($bookings as $booking): ?>
                                    <tr>
                                        ...
                                        <?php if($booking->status == "confirmed") : ?>
                                            <td><a href="<?php echo APPURL; ?>/users/review.php" class="btn btn-success text-white">review us</a></td>
                                        <?php endif; ?>
                                    </tr>
                                <?php  endforeach; ?>
