                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">Selamat datang di Gourmet Haven, destinasi kuliner terbaik untuk menikmati hidangan lezat dan pengalaman makan yang tak terlupakan. Di sini, kami menyajikan hidangan istimewa yang dibuat dengan bahan-bahan segar dan cita rasa autentik. Setiap hidangan kami dirancang untuk memanjakan lidah Anda dan memberikan kenikmatan yang tiada tara.</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <a type="button" href="<?php echo APPURL ;?>/foods/add-cart.php?id=<?php echo $meal_1->id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                        </div>
                                    </div>
                                </div>
                               <?php endforeach;?>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <a type="button" href="<?php echo APPURL ;?>/foods/add-cart.php?id=<?php echo $meal_2->id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach;?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="w-100 d-flex flex-column text-start ps-4">
                                                    ...
                                                    <a type="button" href="<?php echo APPURL ;?>/foods/add-cart.php?id=<?php echo $meal_3->id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach;?>
