...
<?php 
    ...
    class App{
        ...
        public function validateSessionAdmin(){
            if(isset($_SESSION['id'])){
                echo "<script>window.location.href='".ADMINURL."/admin-panel/index.php'</script>";
            }
        }

        public function validateSessionAdminInside(){
            if(isset($_SESSION['id'])){
                echo "<script>window.location.href='".ADMINURL."/admin-panel/admins/login-admins.php'</script>";
            }
        }
